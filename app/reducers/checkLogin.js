 ...
 */
import {LOGIN_SUCCESS,LOGIN_FAIL,SIGNOUT_SUCCESS,SIGNOUT_FAIL,SHOWLOGINDIV,SHOWREGISTERDIV,HIDEMASK} from '../actions/checkLogin';
...
export default function login(state = initLogin ,action){
    switch (action.type){
        case LOGIN_SUCCESS:
            return Object.assign({},state,{login:true,username:action.username,token:action.token,showMask: false,showLoginDiv:false});
        case LOGIN_FAIL:
